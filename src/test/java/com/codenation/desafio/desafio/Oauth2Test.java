...
public class Oauth2Test {
    ...
    @Test
    public void whenNotLoggedInShowAllEventLogs() throws Exception {
        String uri = "/eventlog";
    ...
    @Test
    public void whenLoggedInShowAllEventLogs() throws Exception {
        String token = obtainAccessToken("bruno@gmail.com", "123456");
        String uri = "/eventlog";

        MvcResult mvcResult = mockMvc.perform(MockMvcRequestBuilders.get(uri).header("Authorization", "Bearer " + token)
